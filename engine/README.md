...
> Nota de estructura: este backend vive en `engine/` dentro del monorepo.
> - Infraestructura (`docker-compose.yml`) está en la raíz del repo.
> - UI estática está en `../frontend/static`.
